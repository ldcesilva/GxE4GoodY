# Modified from https://github.com/igorkf/Maize_GxE_Prediction/tree/main/src/preprocessing.py
...
def create_state_location(df: pd.DataFrame):
    df['State_Location'] = df['Env'].str[:2]
    return df    
